            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeatureID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FirstPostTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    FirstPostStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SecondFeatureID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SecondtPostTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecondPostDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecondPostImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecondPostStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
